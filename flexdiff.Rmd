...
As part of my current responsibilities, I receieve statistical tables saved as data sets (e.g. .sas7bdat, .csv) that I further process in R. Given that this work flow is well established, I looked at whether comparisons between statistical tables were feasible with the packages outlined in this tutorial. One of the primary aims would be to detect changes between versions.
